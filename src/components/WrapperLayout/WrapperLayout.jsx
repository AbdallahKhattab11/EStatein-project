...
const WrapperLayout = ({wrapperData, customCard}) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      {wrapperData.map((obj)=> {
        return <div key={obj.id} className="card p-5 border border-gray15 rounded-xl flex flex-col gap-5">
      ...
      <div className="custom-card bg-gray10 rounded-xl p-5 col-span-1 md:col-span-2 flex flex-col gap-5 relative z-0">
